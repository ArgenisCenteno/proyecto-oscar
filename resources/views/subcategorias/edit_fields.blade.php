<form action="{{ route('subcategorias.update', $subcategoria->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        @if($subcategoria->imagen)
            <div class="col-md-6 mb-3">
                ...
                <img src="{{ asset('storage/' . $subcategoria->imagen) }}" alt="Imagen actual" class="img-fluid"
                    style="max-height: 150px; border:1px solid #ddd; border-radius:8px; padding:5px;">
            </div>
        @endif
    ...
    <div class="d-flex justify-content-end">
        <a class="btn btn-danger me-2" href="{{ route('subcategorias.index') }}">Cancelar</a>
