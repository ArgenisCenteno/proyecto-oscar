...
@section('title', 'Subcategorias de Productos') {{-- Título de la página --}}

@section('page_title', 'Subcategorias de Productos') {{-- Título en el breadcrumb --}}
...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-end">
             ...
             <a href="{{ route('subcategorias.create') }}" class="btn btn-primary">Registrar</a> 
        </div>
        <div class="card-body">
