...
<body class="horizontal-layout horizontal-menu content-detached-left-sidebar navbar-floating footer-static  "
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    @foreach ($categorias as $categoria)
                        <li class="dropdown nav-item" data-menu="dropdown">
                            <a class="dropdown-toggle nav-link d-flex align-items-center" href="{{route('shop.categoria', $categoria->id)}}"
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0"> Subcategorías de Productos
                            </h2>
 <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                   ...
                                   <li class="breadcrumb-item"><a href="#">Subcategorías</a>
                                    </li>
                                    <li class="breadcrumb-item active">{{$actual->nombre ?? ''}}
                                    </li>
                                </ol>
                            </div>
                        </div>
