...
@section('title', 'Cupones') {{-- Título de la página --}}

@section('page_title', 'Cupones') {{-- Título en el breadcrumb --}}
...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-end">
             ...
             <a href="{{ route('cupones.create') }}" class="btn btn-primary">Registrar</a> 
        </div>
        <div class="card-body">
            @include('cupones.table') 
        </div>
    </div>
@endsection
